...
scr_input_keyboard();
if !door_unlocked && global.world6unlock && InputInteract && rectangle_in_rectangle(obj_gario.bbox_left, obj_gario.bbox_bottom, obj_gario.bbox_right, obj_gario.bbox_top, bbox_left, bbox_bottom, bbox_right, bbox_top) {
